...
2. 有相等实根场合(${\lambda _1} = {\lambda _2} =  \cdots  = {\lambda _d}$)
...
（1） AR模型自相关系数的表达式是一个齐次差分方程，设它的通解形式为
...
（3） 拖尾性
$${c_1}, \cdots ,{c_p}不能全为零
\Rightarrow {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\rho _k} = \sum\limits_{i = 1}^p {{c_i}\lambda _i^k}始终有非零取值，\forall k > 某个常数$$
