...
- MA(1)模型
  ...
  $${\rho _k} = \left\{ \begin{array}{l}
  1{\rm{             ,}}k = 0\\
  \frac{{ - {\theta _1}}}{{1 + \theta _1^2}}{\rm{   }}{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\rm{,}}k = 1\\
  0{\rm{         }}{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\rm{ ,}}k \ge 2
  \end{array} \right.$$
...
- MA(q)模型的可逆条件是：
  ...
  即$\left| {{\lambda _i}} \right| < 1$

  等价条件是移动平滑系数多项式的根都在单位圆外

  即$\left| {\frac{1}{{{\lambda _i}}}} \right| > 1$
...
对于一个可逆MA(q)模型，可以等价写成$AR(\infty )$模型形式$I(B){x_t}{\kern 1pt}  = {\varepsilon _t}$

 其中$\left\{ \begin{array}{l}{I_0} = 1\\
{I_j} = \sum\limits_{k = 1}^l {{{\theta '}_k}{I_{j - k}}} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,j \ge 1
\end{array} \right.$
...
- 传递形式
  ...
  \left\{ \begin{array}{l}
  {G_0} = 1\\
  {G_k} = \sum\limits_{j = 1}^k {{{\phi '}_j}{G_{k - j}} - {{\theta '}_k}} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} k \ge 1
  \end{array} \right.\\
  其中：{{\phi '}_j} = \left\{ \begin{array}{l}
  {\phi _j}{\rm{   }},{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} 1 \le j \le q\\
  0{\rm{     ,}}{\kern 1pt} {\kern 1pt} j > q
  \end{array} \right.
  \end{array}$$
...
- 逆转形式
  ...
  \left\{ \begin{array}{l}
  {I_0} = 1\\
  {I_k} = \sum\limits_{j = 1}^k {{{\theta '}_j}{I_{k - j}} - {{\phi '}_k}} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} k \ge 1
  \end{array} \right.\\
  其中：{{\theta '}_j} = \left\{ \begin{array}{l}
  {\theta _j}{\rm{   }},{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} 1 \le j \le q\\
  0{\rm{     ,}}{\kern 1pt} {\kern 1pt} j > q
  \end{array} \right.
  \end{array}$$
...
![](E:/github_repo/time_series/Notes/建模步骤.png)
...
- 样本相关系数的近似分布
  ...
  $${\hat \rho _k}\~N(0,\frac{1}{n}){\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,n \to \infty $$

  Quenouille

  $${\hat \varphi _{kk}}\~N(0,\frac{1}{n}){\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,n \to \infty $$
...
{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt}  \vdots \\
{\rho _{p + q}}({\phi _1}, \cdots ,{\phi _p},{\theta _1}, \cdots ,{\theta _q}) = {{\hat \rho }_{p + q}}
\end{array} \right.$$

- 样本一阶均值估计总体均值，样本方差估计总体方差

\[\hat \mu  = \bar x = \frac{{\sum\limits_{i = 1}^n {{x_i}} }}{n}\]\[\hat \sigma _\varepsilon ^2 = \frac{{1 + \hat \varphi _1^2 +  \cdots  + \hat \varphi _p^2}}{{1 + \hat \theta _1^2 +  \cdots  + \hat \theta _q^2}}\hat \sigma _x^2\]
...
\end{array} \right.\]\[{\hat \varphi _1} = \frac{{1 - {{\hat \rho }_2}}}{{1 - \hat \rho _1^2}}{\hat \rho _1}\]\[{\hat \varphi _2} = \frac{{{{\hat \rho }_2} - \hat \rho _1^2}}{{1 - \hat \rho _1^2}}\]
...
\[\begin{array}{c}
Q(\hat \beta ) = \min Q(\tilde \beta ){\kern 1pt} \\
...
\[{x_t} = 0{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} t \le 0\]

- 残差平方和方程

\[Q(\tilde \beta ) = \sum\limits_{i = 1}^n {\varepsilon _t^2} {\kern 1pt}  = \sum\limits_{i = 1}^n {{{[{x_t} - \sum\limits_{i = 1}^t {{\pi _i}{x_{t - 1}}} ]}^2}} \]
...
$LB = n(n + 2)\sum\limits_{k = 1}^m {(\frac{{\hat \rho _k^2}}{{n - k}})} \~{\chi ^2}(m)$
...
\[{H_0}:{\beta _j} = 0{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt}  \leftrightarrow {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {H_1}:{\beta _j} \ne 0{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} \forall 1 \le j \le m\]

- 检验统计量

\[T = \sqrt {n - m} \frac{{{{\hat \beta }_j} - {\beta _j}}}{{\sqrt {{a_{jj}}Q(\tilde \beta )} }}\~t(n - m)\]
...
{x_{t + l}} = \left( {{\varepsilon _{t + l}} + {G_1}{\varepsilon _{t + l - 1}} +  \cdots  + {G_{l - 1}}{\varepsilon _{t + 1}}} \right) + \left( {{G_l}{\varepsilon _t} + {G_{l + 1}}{\varepsilon _{t - 1}} +  \cdots } \right)\\
 = {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {e_t}(l){\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt}  + {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {{\hat x}_t}(l)
\end{array}\]
推导出：
$$\begin{array}{l}
E({x_{t + l}}\left| {{x_t},{x_{t - 1}}, \cdots } \right.) = \hat x(l)\\
{\kern 1pt} {\kern 1pt} Var({x_{t + l}}\left| {{x_t},{x_{t - 1}}, \cdots } \right.) = Var[{e_t}(l)]
\end{array}$$
...
\mu  - \sum\limits_{i = l}^q {{\theta _i}{\varepsilon _{t + l - i}}} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,l \le q\\
\mu {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,l > q
\end{array} \right.\]
    3.2 预测方差
    \[Var[{e_t}(l)] = \left( \begin{array}{l}
(1 + \theta _1^2 +  \cdots  + \theta _{l - 1}^2)\sigma _\varepsilon ^2{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,l \le q\\
(1 + \theta _1^2 +  \cdots  + \theta _q^2)\sigma _\varepsilon ^2{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,l > q
\end{array} \right.\]
    3.3 95%置信区间
...
{{\hat x}_t}(k){\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,k \ge 1\\
{x_{t + k}}{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} ,k \le 0
\end{array} \right.\]
    4.2 预测方差
...
2. 方法
    2.1 在新的信息量比较大时——把新信息加入到旧的信息中，重新拟合模型
    2.2 在新的信息量很小时——不重新拟合模型，只是将新的信息加入以修正预测值，提高预测精度
3. 原理
