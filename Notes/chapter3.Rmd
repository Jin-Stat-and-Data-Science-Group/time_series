...
* 特征根
${\lambda _1} = \frac{{{\phi _1} + \sqrt {\phi _1^2 + 4{\phi _2}} }}{2}                                                                        {\lambda _2} = \frac{{{\phi _1} - \sqrt {\phi _1^2 + 4{\phi _2}} }}{2}$
* 平稳域
...
$$\left| {{\lambda _i}} \right| < 1                                         \Rightarrow                                         {\rho _k} = \sum\limits_{i = 1}^p {{c_i}\lambda _i^k}  \to 0$$
...
- 样本相关系数的近似分布
  ...
  $${\hat \rho _k}\~N(0,\frac{1}{n})            ,n \to \infty $$

  Quenouille

  $${\hat \varphi _{kk}}\~N(0,\frac{1}{n})            ,n \to \infty $$
