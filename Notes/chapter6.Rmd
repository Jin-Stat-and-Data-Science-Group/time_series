...
其中：${\omega _t} \stackrel{\mathrm{i.i.d}}{\sim} N{\rm{(}}0{\rm{,}}\sigma _\omega ^2{\rm{),}}{\upsilon _t}\stackrel{\mathrm{i.i.d}}{\sim} N{\rm{(}}0{\rm{,}}\sigma _\upsilon ^2{\rm{),}}\text{且}Cov({\omega _t},{\upsilon _s}) = 0,{\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} {\kern 1pt} \forall t,s \in T$
...
当$\left| {{\phi _1}} \right| = 1$时，${{\phi _1}}$的渐进分布将不再为正态分布。为了区分于传统的t分布检验统计量，记\[\tau  = \frac{{\left| {{{\hat \phi }_1}} \right| - 1}}{{S({{\hat \phi }_1})}}\]
